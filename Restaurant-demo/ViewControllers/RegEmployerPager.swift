...
class RegEmployerPager: UIViewController, UIPageViewControllerDelegate {
    
    @IBOutlet weak var backButton: UIButton!
    @IBOutlet weak var nextButton: UIButton!
    
    var presenter: RegEmployerPresenterProtocol?
    
    var controllers: [RegEmployerSubController] = []
...
extension RegEmployerPager: UIPageViewControllerDataSource {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        
        guard let viewControllerIndex = controllers.firstIndex(of: viewController as! RegEmployerSubController) else { return nil }
